...
input_file = input_file.replace('<Parameter name="file"><![CDATA[/home/duvi/Documents/MapBox/project/general_empty/layers/hillshade_30.tif]]></Parameter>', ' <Parameter name="file"><![CDATA[' + args.external_layers_folder + '/hillshade_30.tif]]></Parameter>')
input_file = input_file.replace('<Parameter name="file"><![CDATA[/home/duvi/Documents/MapBox/project/general_empty/layers/hillshade_90.tif]]></Parameter>', '<Parameter name="file"><![CDATA[' + args.external_layers_folder + '/hillshade_90.tif]]></Parameter>')
...
if args.input_project_file:
    ...
    input_file = input_file.replace('/home/duvi/Documents/MapBox/project/general_empty/layers/hillshade_30.tif', args.external_layers_folder + '/hillshade_30.tif')
    input_file = input_file.replace('/home/duvi/Documents/MapBox/project/general_empty/layers/hillshade_90.tif', args.external_layers_folder + '/hillshade_90.tif')
    input_file = input_file.replace('/home/duvi/Documents/MapBox/project/general_empty/layers/hillshade_700.tif', args.external_layers_folder + '/hillshade_700.tif')
    input_file = input_file.replace('/home/duvi/Documents/MapBox/project/general_empty/layers/hillshade_1000.tif', args.external_layers_folder + '/hillshade_1000.tif')
    input_file = input_file.replace('/home/duvi/Documents/MapBox/project/general_empty/layers/hillshade_5000.tif', args.external_layers_folder + '/hillshade_5000.tif')
    input_file = input_file.replace('/home/duvi/Documents/MapBox/project/general_empty/layers/land-low/simplified_land_polygons.shp', args.simplified_land_polygons)
    input_file= input_file.replace('/home/duvi/Documents/MapBox/project/general_empty/layers/land-high/land_polygons.shp', args.land_polygons)
    input_file = input_file.replace('tags -> \'name:en\'', 'tags -> \'name:' + args.language  + '\'')
